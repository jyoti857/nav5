...
export const SET_GLOBAL_ERROR = '@Conexion/SET_GLOBAL_ERROR';
export const SET_GLOBAL_LOADER = '@Conexion/SET_GLOBAL_LOADER';
...
export const GET_AFFILIATED_INDIVIDUALS =
  '@Conexion/GET_AFFILIATED_INDIVIDUALS';
export const SET_AFFILIATED_INDIVIDUALS =
  '@Conexion/SET_AFFILIATED_INDIVIDUALS';
...
export const SET_CREATE_INDIVIDUAL_MODAL =
  '@Conexion/SET_CREATE_INDIVIDUAL_MODAL';
...
export const SET_CONEXION_LOCAL_LOADER = '@Conexion/SET_CONEXION_LOCAL_LOADER';
export const SET_EDIT_CONEXION = '@Conexion/SET_EDIT_CONEXION';
...
export const CONEXION_LOADER_MESSAGE = 'Loading Conexion...';
export const INDIVIDUAL_LOADER_MESSAGE = 'Loading individual Conexions...';
export const ORGANIZATION_LOADER_MESSAGE = 'Loading organization Conexions...';
export const NOTES_LOADER_MESSAGE = 'Loading Conexion Notes...';
export const TIMELINE_LOADER_MESSAGE = 'Loading Conexion Timeline...';
export const INDIVIDUAL_DETAILS_LOADER_MESSAGE =
  'Loading individual Conexion details...';
export const INDIVIDUAL_CONEXION_ORGANISATION_LOADER_MESSAGE =
  'Loading individual Conexion details...';
export const ADDRESS_LOADER_MESSAGE = 'Loading Conexion address...';
export const EDIT_ADDRESS_MESSAGE = 'Editing address...';
export const DELETE_ADDRESS_LOADER_MESSAGE = 'Deleting address...';
export const CREATE_INDIVIDUAL_DETAILS_MESSAGE =
  'Creating individual details...';
export const CREATE_ORGANISATION_DETAILS_MESSAGE =
  'Creating organization details...';
export const EDIT_INDIVIDUAL_DETAILS_MESSAGE = 'Editing individual details...';
export const EDIT_ORGANISATION_DETAILS_MESSAGE =
  'Editing organization details...';
export const CREATE_NOTES_MESSAGE = 'Creating notes...';
export const EDIT_NOTES_MESSAGE = 'Editing notes...';
export const DELETE_NOTES_MESSAGE = 'Deleting notes...';
...
export const EDIT_CONEXION_FORM = 'editConexion';
...
export const STATUS = [
  {key: 'ACTIVE', value: 'ACTV', label: 'Active'},
  {key: 'INACTIVE', value: 'INAC', label: 'In Active'},
];
